...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__35417__auto__,writer__35418__auto__,opt__35419__auto__){
return cljs.core._write.call(null,writer__35418__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__34488__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__34488__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__34488__auto__)){
return or__34488__auto__;
} else {
...
var G__38541 = o;
(G__38541[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
while (G__38543__i < G__38543__a.length) {G__38543__a[G__38543__i] = arguments[G__38543__i + 0]; ++G__38543__i;}
  args = new cljs.core.IndexedSeq(G__38543__a,0);
} 
return G__38542__delegate.call(this,args);};
G__38542.cljs$lang$maxFixedArity = 0;
G__38542.cljs$lang$applyTo = (function (arglist__38544){
...
var old_38545 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_38545))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_38545)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__34476__auto__ = (node === document.activeElement);
if(and__34476__auto__){
var and__34476__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
if(cljs.core.truth_(and__34476__auto____$1)){
...
if(cljs.core.truth_((function (){var and__34476__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__38548 = jsprops;
(G__38548["defaultValue"] = value);

(G__38548["onChange"] = ((function (G__38548,v,value,on_change){
return (function (p1__38546_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__38546_SHARP_);
});})(G__38548,v,value,on_change))
);
...
var vec__38550 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__38550,(0),null);
var id = cljs.core.nth.call(null,vec__38550,(1),null);
var class$ = cljs.core.nth.call(null,vec__38550,(2),null);
...
var temp__4659__auto__ = (function (){var G__38554 = cljs.core.meta.call(null,v);
if((G__38554 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__38554);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__38556_38557 = v;
var G__38556_38558__$1 = (((G__38556_38557 == null))?null:reagent.impl.template.key_from_vec.call(null,G__38556_38557));
if((G__38556_38558__$1 == null)){
} else {
(jsprops["key"] = G__38556_38558__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__38561 = cljs.core.meta.call(null,argv);
if((G__38561 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__38561);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__38562 = (((jsprops == null))?{}:jsprops);
(G__38562["key"] = key);
...
var G__38563 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__38563;
continue;
}
} else {
...
var n__35987__auto___38564 = a.length;
var i_38565 = (0);
while(true){
if((i_38565 < n__35987__auto___38564)){
(a[i_38565] = reagent.impl.template.as_element.call(null,(a[i_38565])));

var G__38566 = (i_38565 + (1));
i_38565 = G__38566;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__35987__auto___38567 = a.length;
var i_38568 = (0);
while(true){
if((i_38568 < n__35987__auto___38567)){
var val_38569 = (a[i_38568]);
if((cljs.core.vector_QMARK_.call(null,val_38569)) && ((reagent.impl.template.key_from_vec.call(null,val_38569) == null))){
(o["no-key"] = true);
} else {
}

(a[i_38568] = reagent.impl.template.as_element.call(null,val_38569));

var G__38570 = (i_38568 + (1));
i_38568 = G__38570;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__34476__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__34476__auto__){
return (ctx["no-key"]);
} else {
return and__34476__auto__;
...
var G__38572 = (cljs.core.count.call(null,argv) - first_child);
switch (G__38572) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__38572){
