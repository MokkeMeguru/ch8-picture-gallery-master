...
var or__34488__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__34488__auto__)){
return or__34488__auto__;
} else {
var or__34488__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__34488__auto____$1)){
return or__34488__auto____$1;
} else {
var or__34488__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__34488__auto____$2)){
return or__34488__auto____$2;
} else {
var or__34488__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__34488__auto____$3)){
return or__34488__auto____$3;
} else {
...
var n__35987__auto__ = a.length;
var i = (0);
while(true){
if((i < n__35987__auto__)){
var c_38481 = (a[i]);
if(cljs.core.truth_((c_38481["cljsIsDirty"]))){
(c_38481["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__35417__auto__,writer__35418__auto__,opt__35419__auto__){
return cljs.core._write.call(null,writer__35418__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__38485 = c;
var G__38485__$1 = (((G__38485 == null))?null:(G__38485["props"]));
if((G__38485__$1 == null)){
return null;
} else {
return (G__38485__$1["argv"]);
}
});
...
var G__38487_38488 = (c["cljsRatom"]);
if((G__38487_38488 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__38487_38488);
}
